//***************************************************************************************
// TriangleTessellation.cpp by Frank Luna (C) 2011 All Rights Reserved.
//
// Demonstrates basic hardware tessellation and displacement mapping using
// triangle patch.
//
// Controls:
...
class BasicTriangleTessellation : public D3DApp
{
public:
...
: D3DApp(hInstance), mTriPatchVB(0),  
  mEyePosW(0.0f, 0.0f, 0.0f), mTheta(1.5f*MathHelper::Pi), mPhi(0.01f*MathHelper::Pi), mRadius(30.0f)
{
	mMainWndCaption = L"Basic Triangle Tessellation Demo";
	mEnable4xMsaa = false;
